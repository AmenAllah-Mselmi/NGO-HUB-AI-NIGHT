...
export default function EditTaskModal({ open, onClose, task, onUpdated }: EditTaskModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (status === 'completed') {
                await completeAllTaskAssignments(task.id, trackingType === 'subtasks' ? subtasks : []);
            }
